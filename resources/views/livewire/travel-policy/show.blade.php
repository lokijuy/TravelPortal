<div class="p-6 bg-white dark:bg-gray-800 shadow-md sm:rounded-lg">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-6">
            <a href="{{ route('travel-policy.index') }}" 
               wire:navigate
            ...
            <div class="flex items-center gap-2">
                @if($policy->status === 'draft')
                    ...
                    <a href="{{ route('travel-policy.edit', $policy) }}" 
                       wire:navigate
        ...
        <div class="mt-8">
            ...
            <ul class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <li class="py-3 flex items-center justify-between">
                    ...
                    <a href="{{ route('travel-policy.attachment.download', $attachment) }}" class="text-sm font-medium text-primary-600 dark:text-primary-500 hover:underline">
                        Download
                    </a>
                </li>
                @endforeach
    ...
    @if (session()->has('message'))
        <div id="toast-success" class="fixed bottom-4 right-4 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert"
             x-data="{ show: true }"
             x-show="show"
