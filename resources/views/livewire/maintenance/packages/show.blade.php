<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-3">
            <a href="{{ route('maintenance.packages.edit', $package) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">
                Edit Package
            </a>
            <a href="{{ route('maintenance.packages.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-md">
                Back to List
            </a>
        </div>
    </div>
                ...
                <div>
                    ...
                    <dl class="mt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ $package->code }}</dd>
                        </div>
                        <div>
