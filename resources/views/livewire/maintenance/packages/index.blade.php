<div class="p-6 bg-white dark:bg-gray-800 shadow-md sm:rounded-lg">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Packages</h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Manage insurance packages and their included coverages
            </p>
        </div>
        <div>
            <a 
                href="{{ route('maintenance.packages.create') }}"
                wire:navigate
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-end gap-2">
                                <a 
                                    href="{{ route('maintenance.packages.show', $package) }}"
                                    wire:navigate 
