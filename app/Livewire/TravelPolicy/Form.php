...
class Form extends Component
{
    ...
    public function mount($policy = null)
    {
        try {
            if ($policy) {
                $travelPolicy = TravelPolicy::findOrFail($policy);
            ...
            return redirect()->route('travel-policy.index');
        } catch (Exception $e) {
    ...
    public function update()
    {
        try {
            ...
            $travelPolicy = TravelPolicy::findOrFail($this->policy['id']);
            $travelPolicy->fill($validatedData['policy']);
    ...
    {
        return view('livewire.travel-policy.form');
    }
} 